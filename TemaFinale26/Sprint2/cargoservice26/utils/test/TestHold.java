...
/*
 * TestHold - test di unita' del POJO Hold (stato della stiva) - SPRINT 2 (regressione).
 * Copre la logica delle tre risposte alla loadrequest (reserved/retrylater/reject,
 * cfr. TP2/TP3), slot5 come area di marcatura, le posizioni IOPort/HOME e il
 * DISENGAGE da timeout (TP4): lo slot riservato viene liberato.
 *
 * Esecuzione (nessuna dipendenza esterna):
 *   cd TemaFinale26/Sprint2/cargoservice26
...
public class TestHold {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("----------------------------------------");
        System.out.println("TestHold (Sprint2): " + passed + " PASS, " + failed + " FAIL");
