...
/*
 * TestHold - test di unita' del POJO Hold (stato della stiva) - SPRINT 1.
 * Copre la logica delle tre risposte alla loadrequest (reserved/retrylater/reject,
 * cfr. TP2/TP3), slot5 come area di marcatura, le posizioni IOPort/HOME e -- nuovo
 * nello Sprint 1 -- il DISENGAGE da timeout (TP4): lo slot riservato viene liberato.
 *
...
public class TestHold {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("----------------------------------------");
        System.out.println("TestHold (Sprint1): " + passed + " PASS, " + failed + " FAIL");
