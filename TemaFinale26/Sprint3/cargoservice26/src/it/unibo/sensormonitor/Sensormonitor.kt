		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
						...
						subscribe(  "cargoservice26sonar" ) //canale DEDICATO del sensor (no parsing condiviso col cargoservice)
