...
class Firefly3 ( name: String, scope: CoroutineScope, isconfined: Boolean=false, isdynamic: Boolean=false ) : 
	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
						CommUtils.outgreen("$name | fase 600ms")
						delay(600) 
				...
				state("charging") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t04",targetState="doFlash",cond=whenTimeout("local_tout_"+name+"_charging"))   
					transition(edgeName="t05",targetState="perceiveFlash",cond=whenEvent("flash"))
				}	 
				...
				state("doFlash") { //this:State
					action { //it:State
						CommUtils.outgreen("$name | *** FLASH! ***")
						emit("flash", "flash(firefly3)" ) 
