...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     with Cluster('ctxsistemas', graph_attr=nodeattr):
          ...
          clients=Custom('clients','./qakicons/symActorWithobjSmall.png')
     clients >> Edge(color='magenta', style='solid', decorate='true', label='<eval<font color="darkgreen"> evalDone</font> &nbsp; >',  fontcolor='magenta') >> sistemas
diag
