...
# Parte C: Robotica e sistemi cyber-fisici (settimane 12-15)
  ...
  **Progetto Finale &mdash; [TemaFinale26 (cargoservice)](TemaFinale26)** — consegna per fasi (le fasi vengono pubblicate man mano che sono consegnate al docente)
    * Sprint 0 (core): 📄 [html](https://htmlpreview.github.io/?https://github.com/Alexing-uni/ISS26_Alexander_Kreuzer/blob/main/TemaFinale26/userDocs/Sprint0_v1.html) | 📕 [pdf](TemaFinale26/userDocs/Sprint0_v1.pdf)
    * Sprint 1 (analisi del problema): 📄 [html](https://htmlpreview.github.io/?https://github.com/Alexing-uni/ISS26_Alexander_Kreuzer/blob/main/TemaFinale26/userDocs/Sprint1_v1.html) | 📕 [pdf](TemaFinale26/userDocs/Sprint1_v1.pdf)
    * Modello qak: 📄 [cargoservice26.qak](TemaFinale26/cargoservice26/src/cargoservice26.qak) — POJO testati ([TestHold](TemaFinale26/cargoservice26/utils/test/TestHold.java): 16 PASS, 0 FAIL)
